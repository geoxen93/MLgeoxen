 ...
 * @author Admin
 */
public class Search_Module_Normal extends javax.swing.JFrame implements ActionListener {
    ...
    JT_lname.setText(rs.getString("lname")); JT_age.setText(rs.getString("age")); 
   ...
   ps.setString(1,s); rs = ps.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Search_Module_Normal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Search_Module_Normal().setVisible(true);
            }
        });
    }
